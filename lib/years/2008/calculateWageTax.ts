...
/**
 * Inputs accepted by WageTax2008.
 */
export interface WageTax2008Inputs {
...
/**
 * Outputs returned by WageTax2008.
 */
export interface WageTax2008Outputs {
...
// TÃ¤tigkeit
let FVBZOSO: BigDecimal = BigDecimal.ZERO()
...
let ZRE4OSO: BigDecimal = BigDecimal.ZERO()
...
let ZRE4VMT: BigDecimal = BigDecimal.ZERO()
// Auf einen Jahreslohn hochgerechnetes RE4 in â‚¬, C (2 Dezimalstellen)
...
let ZTABFBOSO: BigDecimal = BigDecimal.ZERO()
...
/**
 * Calculates the WageTax2008.
 *
 * @params inputs - The inputs for the calculation.
 * @returns The outputs of the calculation.
 */
export function calculateWageTax(inputs: WageTax2008Inputs): WageTax2008Outputs {
  // Inputs
  let {
    AJAHR = 0,
    ALTER1 = 0,
