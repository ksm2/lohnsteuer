...
/**
 * Inputs accepted by WageTax2012.
 */
export interface WageTax2012Inputs {
...
/**
 * Outputs returned by WageTax2012.
 */
export interface WageTax2012Outputs {
...
const RENTBEMESSUNGSGR_OST_2012: BigDecimal = new BigDecimal('57600')
// Rentenbemessungs-Grenze alte Bundesländer in EUR
const RENTBEMESSUNGSGR_WEST: BigDecimal = new BigDecimal('67200')
...
/**
 * Calculates the WageTax2012.
 *
 * @params inputs - The inputs for the calculation.
 * @returns The outputs of the calculation.
 */
export function calculateWageTax(inputs: WageTax2012Inputs): WageTax2012Outputs {
  // Inputs
  let {
    af = 1.0,
    AJAHR = 0,
