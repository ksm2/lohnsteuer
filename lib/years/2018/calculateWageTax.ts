...
/**
 * Inputs accepted by WageTax2018.
 */
export interface WageTax2018Inputs {
...
/**
 * Outputs returned by WageTax2018.
 */
export interface WageTax2018Outputs {
...
/**
 * Calculates the WageTax2018.
 *
 * @params inputs - The inputs for the calculation.
 * @returns The outputs of the calculation.
 */
export function calculateWageTax(inputs: WageTax2018Inputs): WageTax2018Outputs {
  // Inputs
  let {
    af = 1,
    AJAHR = 0,
