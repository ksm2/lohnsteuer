...
/**
 * Inputs accepted by WageTax2009.
 */
export interface WageTax2009Inputs {
...
/**
 * Outputs returned by WageTax2009.
 */
export interface WageTax2009Outputs {
...
/**
 * Calculates the WageTax2009.
 *
 * @params inputs - The inputs for the calculation.
 * @returns The outputs of the calculation.
 */
export function calculateWageTax(inputs: WageTax2009Inputs): WageTax2009Outputs {
  // Inputs
  let {
    AJAHR = 0,
    ALTER1 = 0,
