...
/**
 * Inputs accepted by WageTax2019.
 */
export interface WageTax2019Inputs {
...
/**
 * Outputs returned by WageTax2019.
 */
export interface WageTax2019Outputs {
...
/**
 * Calculates the WageTax2019.
 *
 * @params inputs - The inputs for the calculation.
 * @returns The outputs of the calculation.
 */
export function calculateWageTax(inputs: WageTax2019Inputs): WageTax2019Outputs {
  // Inputs
  let {
    af = 1,
    AJAHR = 0,
  ...
  function MPARA(): void {
    ...
    KVSATZAG = new BigDecimal(String('0.0045')).add(new BigDecimal(String('0.07')))
    if (PVS === 1) {
