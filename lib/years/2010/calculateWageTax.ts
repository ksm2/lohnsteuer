...
/**
 * Inputs accepted by WageTax2010.
 */
export interface WageTax2010Inputs {
...
/**
 * Outputs returned by WageTax2010.
 */
export interface WageTax2010Outputs {
...
let KVSATZAG: BigDecimal = BigDecimal.ZERO().setScale(5)
// Beitragssatz des Arbeitnehmers zur Krankenversicherung (5 Dezimalstellen)
let KVSATZAN: BigDecimal = BigDecimal.ZERO().setScale(5)
...
let PVSATZAG: BigDecimal = BigDecimal.ZERO().setScale(5)
// Beitragssatz des Arbeitnehmers zur Pflegeversicherung (5 Dezimalstellen)
let PVSATZAN: BigDecimal = BigDecimal.ZERO().setScale(5)
...
/**
 * Calculates the WageTax2010.
 *
 * @params inputs - The inputs for the calculation.
 * @returns The outputs of the calculation.
 */
export function calculateWageTax(inputs: WageTax2010Inputs): WageTax2010Outputs {
  // Inputs
  let {
    AF = 0,
    AJAHR = 0,
