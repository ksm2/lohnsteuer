...
/**
 * Inputs accepted by WageTax2014.
 */
export interface WageTax2014Inputs {
...
/**
 * Outputs returned by WageTax2014.
 */
export interface WageTax2014Outputs {
...
const RENTBEMESSUNGSGR_OST: BigDecimal = new BigDecimal('60000')
// Rentenbemessungs-Grenze alte Bundesländer in EUR
const RENTBEMESSUNGSGR_WEST: BigDecimal = new BigDecimal('71400')
...
/**
 * Calculates the WageTax2014.
 *
 * @params inputs - The inputs for the calculation.
 * @returns The outputs of the calculation.
 */
export function calculateWageTax(inputs: WageTax2014Inputs): WageTax2014Outputs {
  // Inputs
  let {
    af = 1.0,
    AJAHR = 0,
