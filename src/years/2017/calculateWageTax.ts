...
/**
 * Inputs accepted by WageTax2017.
 */
export interface WageTax2017Inputs {
...
/**
 * Outputs returned by WageTax2017.
 */
export interface WageTax2017Outputs {
...
/**
 * Calculates the WageTax2017.
 *
 * @params inputs - The inputs for the calculation.
 * @returns The outputs of the calculation.
 */
export function calculateWageTax(inputs: WageTax2017Inputs): WageTax2017Outputs {
  // Inputs
  let {
    af = 1,
    AJAHR = 0,
