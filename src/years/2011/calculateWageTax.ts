...
/**
 * Inputs accepted by WageTax2011.
 */
export interface WageTax2011Inputs {
...
/**
 * Outputs returned by WageTax2011.
 */
export interface WageTax2011Outputs {
...
let RENTBEMESSUNGSGR_OST_2011: BigDecimal = new BigDecimal('57600')
// Rentenbemessungs-Grenze alte Bundesländer in EUR
let RENTBEMESSUNGSGR_WEST: BigDecimal = new BigDecimal('66000')
...
/**
 * Calculates the WageTax2011.
 *
 * @params inputs - The inputs for the calculation.
 * @returns The outputs of the calculation.
 */
export function calculateWageTax(inputs: WageTax2011Inputs): WageTax2011Outputs {
  // Inputs
  let {
    af = 1.0,
    AJAHR = 0,
