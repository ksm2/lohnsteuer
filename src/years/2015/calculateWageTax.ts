...
/**
 * Inputs accepted by WageTax2015.
 */
export interface WageTax2015Inputs {
...
/**
 * Outputs returned by WageTax2015.
 */
export interface WageTax2015Outputs {
...
let JWLSTA: BigDecimal = BigDecimal.ZERO()
// Neu 2015
let JWLSTN: BigDecimal = BigDecimal.ZERO()
// Neu 2015
let JWSOLZA: BigDecimal = BigDecimal.ZERO()
// Neu 2015
let JWSOLZN: BigDecimal = BigDecimal.ZERO()
// Neu 2015
let JWBKA: BigDecimal = BigDecimal.ZERO()
// Neu 2015
let JWBKN: BigDecimal = BigDecimal.ZERO()
// Neu 2015
let K: number = 0
...
let ZRE4VPM: BigDecimal = BigDecimal.ZERO()
// Neu 2015
...
/**
 * Calculates the WageTax2015.
 *
 * @params inputs - The inputs for the calculation.
 * @returns The outputs of the calculation.
 */
export function calculateWageTax(inputs: WageTax2015Inputs): WageTax2015Outputs {
  // Inputs
  let {
    af = 1.0,
    AJAHR = 0,
